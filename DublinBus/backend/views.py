            ...
            for i in range(0, len(journey)):
                ...
                if segment["travel_mode"]=="TRANSIT":
                    ...
                    for res in results:
                        ...
                        if (i==0 and res['arrival_time']>= time) or (i>0 and res['arrival_time']>=segment['start_time']):
