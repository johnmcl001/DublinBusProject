    ...
    return (
      <React.Fragment>
        ...
        <div className=" resultDisplay">
          <Accordion.Toggle
            className=" JourneyPlanner_Table "
          ...
          >
            <div className="row">
              <div className=" NumberContainer ">
                <div
                  className=" position-relative ShowOrders  "
              ...
              >
                Guinness Storehouse container containercontainer
              </h5>
            </div>
          </Accordion.Toggle>
        </div>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <p className="instruction_text ">Walk to O'Conned Street</p>
              ...
              <div
                className="row result_destination  "
                style={{ backgroundColor: color }}
              >
                ...
                <p className="destination_text ">Your Destination</p>
              </div>
            </div>
          </Accordion.Collapse>
        </div>
