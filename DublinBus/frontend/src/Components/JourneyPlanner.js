                            ...
                            <div className="container  SearchByDestinationForm">
                                ...
                                <div className="accordion" id="accordionExample">
                                    <div className='row listDestination border border-white '>
                                        ...
                                        <JouneryPlanner_ToVisitPiont buttonID='button_1' cardID='attraction_1'/>
                                        <JouneryPlanner_ToVisitPiont buttonID='button_2' cardID='attraction_2'/>
                                        <JouneryPlanner_ToVisitPiont buttonID='button_3' cardID='attraction_3'/>
                                        <JouneryPlanner_ToVisitPiont buttonID='button_4' cardID='attraction_4'/>
                                        <JouneryPlanner_ToVisitPiont buttonID='button_5' cardID='attraction_5'/>
