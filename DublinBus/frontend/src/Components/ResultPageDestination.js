...
class ResultPageDestination extends Component {
    ...
    render() {
        return (
            ...
            <div className='EntireBox  container col-md-12  position-absolute bg-light'
                ...
                <div className='row '>
                    ...
                    <div className='col-8 resultLabel  '><h4>To 'To be Change'</h4></div>
                </div>
                        ...
                        <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li className="nav-item">
                                <a className="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                   role="tab" aria-controls="pills-home" aria-selected="true">Option 1</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
                                   role="tab" aria-controls="pills-profile" aria-selected="false">Option 2</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact"
                                   role="tab" aria-controls="pills-contact" aria-selected="false">Option 3</a>
                            </li>
                        </ul>
