...
render()
{
    ...
    return (
        ...
        <React.Fragment>
            ...
            <a className='btn  btn-success border border-secondary ' id={this.props.buttonID} style={{backgroundColor: this.props.PickedAttractionButtonBgColor}}
            ...
            <div className="modal fade " id={this.props.cardID} role="dialog"
                ...
                <div className="modal-dialog  modal-dialog-centered" role="document">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-header border border-success">
                            <h4 className="modal-title" id="exampleModalLongTitle">{this.props.name}</h4>
                        ...
                        <button type="button" className="Delete_bottom btn btn-info col-6" data-dismiss="modal"
                                onClick={ () =>{this.props.removeAttractionFromSelected( {
                                    name: this.props.name,
                                    description: this.props.description,
                                    img: this.props.img
                                });this.props._AddBackSelectedColor(this.props.PickedAttractionButtonBgColor)}}>Remove it from list?
