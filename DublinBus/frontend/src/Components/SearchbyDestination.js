...
import "../static/frontend/stylesheet/SearchbyDestination.css";
...
class SearchbyDestination extends Component {
    ...
    render() {
        return (
            <div>
                <div className='SearchByDestinationBox bg-light container col-md-12  position-absolute' id='EntireBox'>
                                ...
                                <div className='container SearchByDestinationForm'>
                                    ...
                                    <div className='row row_fourth border border-secondary'>
                                        ...
                                        <div className='col-3 form-check  border border-secondary'>
                                            <input type="checkbox" className="form-check-input" id="BusCheckBoc"/>
                                            <label className="form-check-label">Bus</label>
                                        </div>
                                        <div className='col-3 form-check  border border-secondary'>
                                            <input type="checkbox" className="form-check-input" id="LuasCheckBox"/>
                                            <label className="form-check-label">Luas</label>
                                        </div>
                                        <div className='col-3 form-check  border border-secondary'>
                                            <input type="checkbox" className="form-check-input" id="TrainCheckBox"/>
