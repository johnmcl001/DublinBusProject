...
class YourLocationOrSearch extends React.Component {
    ...
    renderInputField() {
        if (this.state.mode === 'view') {
            return <div><GoogleAddressSearch comment='Set Your Start Point' onUpdatePosition={this.props.onUpdatePosition}/></div>;
        } else {
            return (

                    <input id='InputBoxYourLocationOrSearch'
    ...
    render() {
        ...
        return (
            <div YourLocationOrSearch className='row'>
                ...
                <div className='col-2  ClickChangeInput'>
                     {this.renderButton()}
                </div>
